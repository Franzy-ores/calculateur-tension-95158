...
export const PhaseDistributionDisplay = () => {
  ...
  return (
    <div className="flex flex-col gap-2 p-3 bg-white/5 rounded border border-white/10">
      ...
      {/* Ligne 2: Tableau compact Charges / Productions + Récapitulatif */}
      <div className="grid grid-cols-[1fr_1fr_0.8fr] gap-3">
        {/* CHARGES */}
        ...
        <div className="p-3 bg-primary/5 border border-primary/20 rounded">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-xs font-bold text-white">📋 COUPLAGE</span>
